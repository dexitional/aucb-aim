export default function SelectField({ label, name, defaultValue, onChange, options }: any) {
  return (
    <label className="flex flex-col space-y-1">
        ...
        <select name={name} onChange={onChange} defaultValue={defaultValue} className="py-2 px-4 w-full rounded-md border border-(--theme-primary)/50 file:px-3 capitalize">
