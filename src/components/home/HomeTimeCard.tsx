export default function HomeTimeCard() {
  return (
    <div className="flex flex-col space-y-4">
        ...
        <div className="relative shadow rounded-3xl flex space-x-4 bg-(--theme-secondary)/5 overflow-hidden">
            <div className="px-4 py-3 h-32 w-24 rounded-2xl text-white bg-(--theme-primary)/90 flex flex-col items-center justify-center space-y-1">
